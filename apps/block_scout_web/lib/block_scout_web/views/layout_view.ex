defmodule BlockScoutWeb.LayoutView do
  ...
  def chain_id do
    Keyword.get(application_config(), :chain_id)
  end

  def coin do
    Keyword.get(application_config(), :coin)
  end

  def rpc_url do
    Keyword.get(application_config(), :rpc_url)
  end

  def explorer_url do
    Keyword.get(application_config(), :explorer_url)
  end
